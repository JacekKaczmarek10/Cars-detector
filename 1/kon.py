...
cv2.setMouseCallback('image1',draw_P)
f=1
while(f):
...
thresh1 = 100
src_gray=gray
thresh=thresh_callback(thresh1)
cv2.imshow('image123131', thresh)
#print(thresh)
#src_gray=thresh
...
######################################################
        ...
        #print(a)
######################################################
        cv.line(r, (p11,p12),(p21,p22), color, 1)
        cv.line(r, (p31,p32),(p21,p22), color, 1)
        cv.line(r, (p11,p12),(p41,p42), color, 1)
        cv.line(r, (p41,p42),(p31,p32), color, 1)
