...
print('samemu analizować?')
#while(u):
#    if cv2.waitkay(1) & 0xFF == ord('t'):
#        g=2
#        break
...
BODY= {"name" :name ,"numberOfPlaces" : 0,"city" : "Poznań","postalCode":"60-461","street":"saturn"}
...
#FUNKCJIA MA BYĆ TU DO RUTOWANIA TWOICH MIEJC NA MOJE
